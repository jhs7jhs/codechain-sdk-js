...
var SDK = /** @class */ (function () {
    ...
    function SDK(params) {
        ...
        var _c = options || { networkId: undefined, parcelSigner: undefined }, networkIdOpt = _c.networkId, parcelSigner = _c.parcelSigner, _d = _c.parcelFee, parcelFee = _d === void 0 ? 10 : _d;
        this.rpc = new rpc_1.Rpc({ server: server, options: { parcelSigner: parcelSigner, parcelFee: parcelFee } });
