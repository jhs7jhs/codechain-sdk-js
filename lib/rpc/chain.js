...
var ChainRpc = /** @class */ (function () {
     ...
     */
    ChainRpc.prototype.getAsset = function (tracker, index, blockNumber) {
        var _this = this;
        if (!H256_1.H256.check(tracker)) {
        ...
        return new Promise(function (resolve, reject) {
            _this.rpc
                ...
                try {
                    resolve(Asset_1.Asset.fromJSON(__assign({}, result, { tracker: H256_1.H256.ensure(tracker).value, transactionOutputIndex: index })));
                }
                catch (e) {
