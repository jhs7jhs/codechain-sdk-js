...
var NetworkRpc = /** @class */ (function () {
     ...
     * @param port
     */
    NetworkRpc.prototype.shareSecret = function (secret, address, port) {
        var _this = this;
     ...
     * @param ip Node IP
     */
    NetworkRpc.prototype.addToWhitelist = function (ip, tag) {
        var _this = this;
     ...
     * @param ip Node IP
     */
    NetworkRpc.prototype.removeFromWhitelist = function (ip) {
        var _this = this;
        if (!isIpAddressString(ip)) {
     ...
     * @param ip Node IP
     */
    NetworkRpc.prototype.addToBlacklist = function (ip, tag) {
        var _this = this;
        if (!isIpAddressString(ip)) {
     ...
     * @param ip Node IP
     */
    NetworkRpc.prototype.removeFromBlacklist = function (ip) {
        var _this = this;
        if (!isIpAddressString(ip)) {
    ...
    NetworkRpc.prototype.disableBlacklist = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.rpc.sendRpcRequest("net_disableBlacklist", []).then(function (result) {
                if (result === null) {
                    return resolve(null);
                }
