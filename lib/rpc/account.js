...
var AccountRpc = /** @class */ (function () {
     ...
     * @hidden
     */
    function AccountRpc(rpc, options) {
        var parcelFee = options.parcelFee;
        this.rpc = rpc;
     ...
     */
    AccountRpc.prototype.sendParcel = function (params) {
        var parcel = params.parcel, account = params.account, passphrase = params.passphrase;
