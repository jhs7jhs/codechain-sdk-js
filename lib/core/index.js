...
var Core = /** @class */ (function () {
    ...
    Core.prototype.createOrder = function (params) {
        var assetTypeFrom = params.assetTypeFrom, assetTypeTo = params.assetTypeTo, _a = params.assetTypeFee, assetTypeFee = _a === void 0 ? "0".repeat(64) : _a, assetQuantityFrom = params.assetQuantityFrom, assetQuantityTo = params.assetQuantityTo, _b = params.assetQuantityFee, assetQuantityFee = _b === void 0 ? 0 : _b, originOutputs = params.originOutputs, expiration = params.expiration;
        ...
        for (var i = 0; i < originOutputs.length; i++) {
            ...
            var tracker = originOutput.tracker, index = originOutput.index, assetType = originOutput.assetType, quantity = originOutput.quantity, lockScriptHash = originOutput.lockScriptHash, parameters = originOutput.parameters;
    ...
    Core.prototype.createChangeAssetSchemeTransaction = function (params) {
        var assetType = params.assetType, scheme = params.scheme, _a = params.approvals, approvals = _a === void 0 ? [] : _a;
        if (scheme !== null && typeof scheme !== "object") {
            throw Error("Expected scheme param to be either an AssetScheme or an object but found " + scheme);
        }
    ...
    Core.prototype.createUnwrapCCCTransaction = function (params) {
        var burn = params.burn, _a = params.networkId, networkId = _a === void 0 ? this.networkId : _a, _b = params.approvals, approvals = _b === void 0 ? [] : _b;
        checkNetworkId(networkId);
    ...
    Core.prototype.createAssetTransferInput = function (params) {
        ...
        var tracker = assetOutPoint.tracker, index = assetOutPoint.index, assetType = assetOutPoint.assetType, quantity = assetOutPoint.quantity, lockScriptHash = assetOutPoint.lockScriptHash, parameters = assetOutPoint.parameters;
    ...
    Core.prototype.createAssetOutPoint = function (params) {
        var tracker = params.tracker, index = params.index, assetType = params.assetType, quantity = params.quantity;
...
function checkAssetOutPoint(value) {
    ...
    var tracker = value.tracker, index = value.index, assetType = value.assetType, quantity = value.quantity, lockScriptHash = value.lockScriptHash, parameters = value.parameters;
    checkTracker(tracker);
    checkIndex(index);
    checkAssetType(assetType);
    checkAmount(quantity);
