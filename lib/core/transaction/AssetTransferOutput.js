...
var AssetTransferOutput = /** @class */ (function () {
    ...
    function AssetTransferOutput(data) {
        ...
        var assetType = data.assetType, quantity = data.quantity;
    ...
    AssetTransferOutput.fromJSON = function (data) {
        var lockScriptHash = data.lockScriptHash, parameters = data.parameters, assetType = data.assetType, quantity = data.quantity;
    ...
    AssetTransferOutput.prototype.toEncodeObject = function () {
        var _a = this, lockScriptHash = _a.lockScriptHash, parameters = _a.parameters, assetType = _a.assetType, quantity = _a.quantity;
        return [
