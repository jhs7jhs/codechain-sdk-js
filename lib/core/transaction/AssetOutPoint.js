...
var AssetOutPoint = /** @class */ (function () {
    ...
    function AssetOutPoint(data) {
        var tracker = data.tracker, index = data.index, assetType = data.assetType, quantity = data.quantity, lockScriptHash = data.lockScriptHash, parameters = data.parameters;
    ...
    AssetOutPoint.fromJSON = function (data) {
        var tracker = data.tracker, index = data.index, assetType = data.assetType, quantity = data.quantity;
        return new this({
    ...
    AssetOutPoint.prototype.toEncodeObject = function () {
        var _a = this, tracker = _a.tracker, index = _a.index, assetType = _a.assetType, quantity = _a.quantity;
        return [
