...
var Key = /** @class */ (function () {
     ...
     * @returns A new platform address
     */
    Key.prototype.createAssetTransferAddress = function (params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    Key.prototype.signParcel = function (parcel, params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        sig = _c.sent();
                        return [2 /*return*/, new classes_1.SignedParcel(parcel, sig)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        ...
                        input = "inputs" in tx ? tx.inputs[index] : tx.input;
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        burn = "burns" in tx ? tx.burns[index] : tx.burn;
